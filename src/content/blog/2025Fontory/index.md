...
2. 템플릿 무결성 검사
    ...
    ![템플릿 무결성 검사 예시 - 왜곡된 템플릿](/public/blog/2025Fontory/overlay_with_inline_legend.png)
...
3. 흑백 이진화 및 색상 후처리
    ...
    | ------------------------------------------------------------------ | ----------------------------------------------------------------------- |
    | ![검정색이 아닌 글씨](/public/blog/2025Fontory/resized_test1.jpeg) | ![검정색으로 변환된 글씨](/public/blog/2025Fontory/binarized_test.jpeg) |
...
4. 좌표 기반 글리프 Crop & 저장
    ...
    | 업로드된 이미지                                        | 실제 추출할 부분                                            |
    | ------------------------------------------------------ | ----------------------------------------------------------- |
    | ![업로드된 이미지](/public/blog/2025Fontory/image.png) | ![실제 추출할 부분](/public/blog/2025Fontory/image%201.png) |
...
3. 추론 시간 측정
    - `time.time()` 으로 경과 시간을 계산해 `추론 완료: XX.XX초 소요` 형태로 로깅한다.
      ![Screenshot 2025-07-06 at 10.13.07 PM.png](/public/blog/2025Fontory/Screenshot_2025-07-06_at_10.13.07_PM.png)
...
3. 결과 검증 및 통계 수집
    ...
    - `SVG` 내부 `<path>` 태그 개수 파싱하여 벡터 요소 수 집계한다.
      ![Screenshot 2025-07-06 at 10.24.20 PM.png](/public/blog/2025Fontory/Screenshot_2025-07-06_at_10.24.20_PM.png)
...
1. Base 폰트 병합 및 후처리
    ...
    | ------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
    | ![적용 전: 일관 되지 않은 글자 높이](/public/blog/2025Fontory/0246f818-a660-419d-bb6b-61044036c8c5.png) | ![적용 후: 일관된 글자 높이](/public/blog/2025Fontory/97edf0b3-b3d8-4b17-afdc-f39bab4c2c5a.png) |
...
5. 최종 로깅
    ...
    ![Screenshot 2025-07-06 at 10.49.17 PM.png](/public/blog/2025Fontory/Screenshot_2025-07-06_at_10.49.17_PM.png)
...
![Screenshot 2025-07-05 at 12.39.02 AM.png](/public/blog/2025Fontory/Screenshot_2025-07-05_at_12.39.02_AM.png)
...
![Screenshot 2025-07-08 at 2.21.04 AM.png](/public/blog/2025Fontory/Screenshot_2025-07-08_at_2.21.04_AM.png)
...
![Recover: DLQ 적재 + Discord 알림](/public/blog/2025Fontory/Screenshot_2025-07-08_at_2.57.43_AM.png)
...
| ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| ![Grafana 대시보드](/public/blog/2025Fontory/Screenshot_2025-07-06_at_9.38.35_PM.png) | ![실시간 로그 확인 ](/public/blog/2025Fontory/e8c47486-335e-4ccf-b10f-26ef49bc9226.png) |
...
![외부 API와 동기적으로 실행되었던 폰트 생성 로직](/public/blog/2025Fontory/Screenshot_2025-07-06_at_10.55.49_PM.png)

외부 API와 동기적으로 실행되었던 폰트 생성 로직

![외부 API 로직과 폰트 생성 로직을 서로 다른 프로세스가 처리 하도록 분리](/public/blog/2025Fontory/Screenshot_2025-07-06_at_10.56.09_PM.png)

외부 API 로직과 폰트 생성 로직을 서로 다른 프로세스가 처리 하도록 분리

| 기존 응답속도                                                                        | 리펙터링 후 응답속도                                                                        |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------- |
| ![기존 응답속도 ](/public/blog/2025Fontory/Screenshot_2025-07-05_at_12.58.21_AM.png) | ![리펙터링 후 응답속도 ](/public/blog/2025Fontory/Screenshot_2025-07-05_at_12.58.38_AM.png) |
